...
progress_file = "log/progress_UpTo2to2.log"
outfile_amplitudes =  "../data.nosync/QED_amplitudes_TreeLevel_UpTo2to2.txt"
outfile_sqamplitudes_simplified =  "../data.nosync/QED_sqamplitudes_TreeLevel_UpTo2to2_simplified.txt"
outfile_sqamplitudes_simplified_prefix =  "../data.nosync/QED_sqamplitudes_TreeLevel_UpTo2to2_simplified_shortened_hybridprefix.txt"
timeout_logfile = "log/timeout_log_UpTo2to2.log"
