...
# amplitudes_folders_names = ["1to2/", "2to1/", "2to2/"]#, "2to3/", ]# "3to2/", "3to3/",]
amplitudes_folders_names = ["1to2/"]#, "2to3/", ]# "3to2/", "3to3/",]
...
progress_file = "log/progress_1to2.log"
outfile_amplitudes =  "../../data.nosync/QED_amplitudes_TreeLevel_1to2.txt"
outfile_sqamplitudes_simplified =  "../../data.nosync/QED_sqamplitudes_TreeLevel_1to2.txt"
outfile_sqamplitudes_simplified_prefix =  "../../data.nosync/QED_sqamplitudes_TreeLevel_1to2_simplified_shortened_hybridprefix.txt"
timeout_logfile = "log/timeout_log_1to2.log"
