...
# amplitudes_folders_names = ["1to2/", "2to1/", "2to2/"]#, "2to3/", ]# "3to2/", "3to3/",]
amplitudes_folders_names = ["2to1/"]#, "2to3/", ]# "3to2/", "3to3/",]
...
progress_file = "log/progress_2to1.log"
outfile_amplitudes =  "../../data.nosync/QED_amplitudes_TreeLevel_2to1.txt"
outfile_sqamplitudes_simplified =  "../../data.nosync/QED_sqamplitudes_TreeLevel_2to1.txt"
outfile_sqamplitudes_simplified_prefix =  "../../data.nosync/QED_sqamplitudes_TreeLevel_2to1_simplified_shortened_hybridprefix.txt"
timeout_logfile = "log/timeout_log_2to1.log"
